...
import com.clark.gldemo.MyTDView;
import com.clark.utils.ShadeUtil;
...
public class Triangle{
    ...
    public void initShader(MyTDView mv){
        //加载顶点着色器的脚本内容
        mVertexShader=ShadeUtil.loadFromAssetsFile("vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader= ShadeUtil.loadFromAssetsFile("frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
        mProgram = ShadeUtil.createProgram(mVertexShader, mFragmentShader);
        //获取程序中顶点位置属性引用id
