...
public final class Encoder {
    ...
    public static QRCode encode(String content,
        ...
        MatrixUtils.buildMatrix(finalBits, ecLevel, version, maskPattern, matrix);
    ...
    private static int chooseMaskPattern(BitArray bits,
        ...
        for (int maskPattern = 0; maskPattern < QRCode.NUM_MASK_PATTERNS; maskPattern++) {
            MatrixUtils.buildMatrix(bits, ecLevel, version, maskPattern, matrix);
    ...
    static byte[] generateECBytes(byte[] dataBytes, int numEcBytesInBlock) {
        ...
        new ReadSolomonEncoder(GenericGF.QR_CODE_FIELD_256).encode(toEncode, numEcBytesInBlock);
